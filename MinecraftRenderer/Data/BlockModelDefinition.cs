...
public sealed class BlockModelDefinition
{
	...
	public Dictionary<string, TransformDefinition>? Display { get; init; }

	[JsonPropertyName("elements")]
	public List<ElementDefinition>? Elements { get; init; }

	[JsonPropertyName("gui_light")]
	public string? GuiLight { get; init; }
...
public sealed class ElementDefinition
{
	...
	[JsonPropertyName("rotation")]
	public ElementRotationDefinition? Rotation { get; init; }

	[JsonPropertyName("faces")]
	public Dictionary<string, FaceDefinition>? Faces { get; init; }
...
public sealed class FaceDefinition
{
	...
	public string? CullFace { get; init; }
}
